 ...
 de parâmetros que são usados para preencher a consulta. O método trata exceções, gerencia recursos e fornece 
    ...
    public void save(String comandoSql, Object... parametros) {
        ...
        try {
            ...
            //Mudança para suportar LocalDateTime
            for (int i = 0; i < parametros.length; i++) {
                ...
                if (param instanceof LocalDateTime) {
                    ...
                    pstmt.setTimestamp(i + 1, new Timestamp(calendar.getTimeInMillis()));
                } else {
    ...
    public int salvarRetornandoID(String comandoSql, Object... parametros) {
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        int idGerado = -1;
        ...
        try {
            ...
            // Inserção de parâmetros, incluindo suporte a LocalDateTime
            for (int i = 0; i < parametros.length; i++) {
                Object param = parametros[i];
                if (param instanceof LocalDateTime) {
                    pstmt.setTimestamp(i + 1, Timestamp.valueOf((LocalDateTime) param));
            ...
            if (linhasAfetadas > 0) {
                ...
                if (rs.next()) {
                    ...
                    lastId = idGerado; // Atualiza também o campo interno, se necessário
                    System.out.println("ID gerado com sucesso: " + idGerado);
                }
            } else {
    ...
    public T buscarUm(String comandoSql, RowMapper<T> rowMapper, Object... parametros) {
        T entidade = null;
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public List<T> buscarTodosComParametro(String comandoSql, RowMapper<T> rowMapper, Object... parametros) {
        List<T> entidades = new ArrayList<>();
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
    ...
    public double buscarDouble(String sql, Object... parametros) {
        Double valor = null;
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            if (rs.next()) {
                valor = rs.getDouble(1); // pega a primeira coluna
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
